...
const locales = [
  { id: "zh-Hant", key: "zhHant", prefix: "/zh-hant", ogLocale: "zh_TW", ogAlternates: ["en_US", "zh_CN", "de_DE", "es_ES", "fr_FR", "ja_JP"], languageAria: "語言選擇" },
  { id: "zh-Hans", key: "zhHans", prefix: "/zh-hans", ogLocale: "zh_CN", ogAlternates: ["en_US", "zh_TW", "de_DE", "es_ES", "fr_FR", "ja_JP"], languageAria: "语言选择" },
  { id: "de", key: "de", prefix: "/de", ogLocale: "de_DE", ogAlternates: ["en_US", "zh_TW", "zh_CN", "es_ES", "fr_FR", "ja_JP"], languageAria: "Sprachauswahl" },
  { id: "es", key: "es", prefix: "/es", ogLocale: "es_ES", ogAlternates: ["en_US", "zh_TW", "zh_CN", "de_DE", "fr_FR", "ja_JP"], languageAria: "Selección de idioma" },
  { id: "fr", key: "fr", prefix: "/fr", ogLocale: "fr_FR", ogAlternates: ["en_US", "zh_TW", "zh_CN", "de_DE", "es_ES", "ja_JP"], languageAria: "Sélection de la langue" },
  { id: "ja", key: "ja", prefix: "/ja", ogLocale: "ja_JP", ogAlternates: ["en_US", "zh_TW", "zh_CN", "de_DE", "es_ES", "fr_FR"], languageAria: "言語を選択" }
];

const translations = { ...common, ...selected, ...ocr, ...offline };
const sourceKeys = Object.keys(translations).sort();
const externalTranslations = { de: german, es: spanish, fr: french, ja: japanese };
